...
cam_x_offset    = 0.045        # Correccion de camara por los gripper, 0.04 / -0.015 0.045
cam_y_offset    = -0.01  #-0.02
#resolution      = 1
...
def transformacion(frame):
	...
	circles =cv2.HoughCircles(gray,cv.CV_HOUGH_GRADIENT,1, 50, param1=40, param2=40,minRadius=20, maxRadius=160)

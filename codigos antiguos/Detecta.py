...
#			cv2.imshow('gray',gray) #mostrar imagen
#			xx=pixel_to_baxter((circles[0][0],circles[0][1]),0.32) #convertir pixel a punto de baxter
#			print xx[0], xx[1] #imprimir ese punto 
			#rate=rospy.Rate(100)			
#			mover_baxter('base',[xx[0], xx[1], -0.03],[-3.09,-0.095,-3.08]) #mover a punto obtenido, desde la transformacion de pixel                
			#rate.sleep()
#			print "Moviendo al punto (xx[0], xx[1])",xx[0],xx[1]
			#yy=pixel_to_baxter(y,0,3)
			#print "Coordenada es: ", xx
			#print "Column Number: "
			#print x
